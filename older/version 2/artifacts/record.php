...
$pageTitle = "A Petry: Record Table";
include(ROOT_PATH . 'inc/header.php'); ?>

	<div class="content grid_12">
		<div class="grid_1 empty-div"></div>
		<div class="feature grid_10">
			<img src="<?php echo BASE_URL; ?>img/record-table-830-600.jpg" alt="Record Table">
		</div>
		<div class="grid_1 empty-div"></div>
		...
		<div class="grid_5 detail1">
			<img src="<?php echo BASE_URL; ?>img/record-detail1-400.jpg" alt="Record Table Detail">
		</div>
		<div class="grid_5 detail2">
			<img src="<?php echo BASE_URL; ?>img/record-detail2-400.jpg" alt="Record Table Detail">
		</div>
		<div class="grid_1 alpha empty-div"></div>
