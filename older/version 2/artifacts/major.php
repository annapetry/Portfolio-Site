...
$pageTitle = "A Petry: Major Arc";
include(ROOT_PATH . 'inc/header.php'); ?>

	<div class="content grid_12">
		<div class="grid_1 empty-div"></div>
		<div class="feature grid_10">
			<img src="<?php echo BASE_URL; ?>img/major-750-600.jpg" alt="Major Arc">
		</div>
		<div class="grid_1 empty-div"></div>
		...
		<div class="grid_6 blurb">
			<p>
				The Major Arc Terrarium Stand.<br>
		...
		<div class="grid_5 detail1">
			<img src="<?php echo BASE_URL; ?>img/major-detail1-400.jpg" alt="Record Table Detail">
		</div>
		<div class="grid_5 detail2">
			<img src="<?php echo BASE_URL; ?>img/major-detail2-400.jpg" alt="Record Table Detail">
		</div>
		<div class="grid_1 alpha empty-div"></div>
