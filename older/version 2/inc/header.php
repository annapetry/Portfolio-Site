...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>css/style-v2.css" type="text/css" media="screen">
		...
		<header>
			<nav>		
				...
				<ul class="right">
					...
					<li>
						<a href="<?php echo BASE_URL; ?>AnnaPetryResumeSF.pdf" target="_blank">RESUME</a>
					</li>
				</ul>
				<hr>
			</nav>		
