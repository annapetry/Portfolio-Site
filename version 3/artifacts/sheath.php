...
include(ROOT_PATH . 'inc/header.php'); ?>
	...
	<div class="content grid_12">
		...
		<div class="feature grid_10">
			<img src="<?php echo BASE_URL; ?>img/sheath-750-600.jpg" alt="Leather Pocketknife Sheath">
		</div>
		...
		<div class="grid_6 blurb">
			<p>
				Pocketknife Sheath<br>
				Materials:<br>
				Natural Cow's Hide, Nylon Thread, Brass Button Stud, Wax
			</p>
		</div>
		...
		<div class="grid_5 detail1">
			<img src="<?php echo BASE_URL; ?>img/sheath-detail2-400.jpg" alt="Sheath Detail">
		</div>
		<div class="grid_5 detail2">
			<img src="<?php echo BASE_URL; ?>img/sheath-detail1-400.jpg" alt="Sheath Detail">
		</div>
		<div class="grid_1 alpha empty-div"></div>
