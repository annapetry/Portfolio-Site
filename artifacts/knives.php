...
$pageTitle = "A Petry: Wooden Knives";
include(ROOT_PATH . 'inc/header.php'); ?>

	<div class="content grid_12">
		<div class="empty_div grid_1"></div>
		<div class="feature grid_10">
			<img src="<?php echo BASE_URL; ?>img/knives-750-350.jpg" alt="Hand-Carved Knives">
		</div>
		...
		<div class="grid_6 blurb">
			<p>
				Butter &amp; Cheese Knives<br>
				Materials:<br> Black Walnut, Maple, Tung Oil
			</p>
		</div>
		...
		<div class="grid_5 detail1">
			<img src="<?php echo BASE_URL; ?>img/knife-detail2-400.jpg" alt="Knife Detail">
		</div>
		<div class="grid_5 detail2">
			<img src="<?php echo BASE_URL; ?>img/knife-detail1-400.jpg" alt="Knife Detail">
		</div>
		<div class="grid_1 alpha empty-div"></div>
